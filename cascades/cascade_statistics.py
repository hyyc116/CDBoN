...
def plot_dict():
    ...
    ax11 = axes[1,0]
    plot_heatmap(cxs,eys,ax11,[10,10])
    ...
    ax12 = axes[1,1]
    plot_heatmap(cxs,rys,ax12,[10,10])
    ...
    ax13 = axes[1,2]
    plot_heatmap(dcxs,dys,ax13,[10,10])
    ...
    ax14 = axes[1,3]
    plot_heatmap(cxs,od_ys,ax14,[10,10])
    ...
    ax15 = axes[1,4]
    plot_heatmap(cxs,id_ys,ax15,[10,10])
