...
def plot_dis_over_count():
    ...
    print 'plotting average CR ... '
    connector_obj = json.loads(open('data/aminer_connector.json').read())

    cxs=connector_obj['cxs']
    acr=connector_obj['acrs']
    ...
    outpath = 'pdf/aminer_compare.png'
